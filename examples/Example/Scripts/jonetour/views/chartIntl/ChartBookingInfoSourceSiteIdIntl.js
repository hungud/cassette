(function () {
    ...
    VA.views.chartIntl.ChartBookingInfoSourceSiteIdIntl = function () {
        ...
        var initTitleChart = function () {
            ...
            $('.title-charts').text('Thống kê mã dịch vụ quốc tế theo nguồn đặt vé');
        ...
        var getDataChartBookingInfoBySourceSiteId = function (bookingStatus, fromDaySourceSiteId, toDaySourceSiteId) {

            getDataBookingInfoBySourceSiteId(bookingStatus, fromDaySourceSiteId, toDaySourceSiteId, prepareDataBookingInfoBySourceSiteId);
        ...
        var getDataBookingInfoBySourceSiteId = function (bookingStatus, fromDaySourceSite_id, toDaySourceSite_id, callback) {
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    P_FROM_DAY: fromDaySourceSite_id,
                    P_TO_DAY: toDaySourceSite_id
                },
        ...
        var bindDataChartBookingInfoSourceSiteIdDayToDay = function (data, total, fromDaySourceSiteId, toDaySourceSiteId, cateTicketInput) {
            $('#bao_cao_theo_nguon_dat_ve').highcharts({
                chart: {
                    plotBackgroundColor: null,
                    plotBorderWidth: null,
                ...
                title: {
                    text: 'Thống kê theo nguồn đặt vé từ ' + fromDaySourceSiteId + ' đến ngày ' + toDaySourceSiteId + ' có ' + total + ' ' + cateTicketInput
                },
                tooltip: {
                    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
