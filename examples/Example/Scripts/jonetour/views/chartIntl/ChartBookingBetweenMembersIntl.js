(function () {
    ...
    VA.views.chartIntl.ChartBookingBetweenMembersIntl = function () {
        ...
        var initTitleChart = function () {
            ...
            $('.title-charts').text('Thống kê mã dịch vụ quốc tế giữa các nhân viên');
        ...
        var getDataBookingBetweenMembers = function (mb_id, from_date, to_date, callback) {
            ...
            jQuery.ajax({
                url: _configs.service_wss_galileo_vietair_tv_url + "/listinfo.asmx/GetDataFlyBookingInfoByMutilMembers",
                dataType: "jsonp",
                data: {
