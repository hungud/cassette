(function () {
    ...
    VA.views.flightCustomerInternational.ManagePolicyCustomerIntl001 = function () {
        ...
        function add() {
            ...
            data_post.package_name = "PK_BD_FS_POLICY_CTM_INTL_001";

            data_post.object_name = "INSERT_POLICY_CTM_INTL_001";
        ...
        function update() {
            ...
            data_post.object_name = "UPDATE_POLICY_CTM_INTL_001";
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    jwm.Alert.HideAjaxProcessing(_configs.form_id);
                    jwm.Alert.ShowMsg('#viewmanageflightcustomerlog', data.TypeMsg, data.Msg, 'VIETAIR-Thông báo');
                ...
                error: function (http, message, exc) {
                    ...
                    jwm.Alert.ShowMsg('#viewmanageflightcustomerlog', -1, message + " " + exc, 'Thông báo');
                }
            });
            return false;
        ...
        var viewManageFlightCustomerIntl = function (sqid) {
            ...
            jQuery.ajax({
                url: "/FlightCustomerInternational/ViewManagePolicyCustomerIntl001Log",
                dataType: 'html',
                type: 'POST',
                data: data_post,
                success: function (data) {
                    ...
                    $('html, body').animate({
                        scrollTop: $("#viewmanageflightcustomerlog").offset().top
                    }, 100);
