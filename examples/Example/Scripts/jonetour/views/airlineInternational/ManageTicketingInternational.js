(function () {
    ...
    VA.views.airlineInternational.ManageTicketingInternational = function () {
        ...
        var initGrid = function () {
            _grid_paged_config = {
                ...
                grid_selector: '#grid',
                ajax_url: _configs.service_wss_galileo_vietair_tv_url + '/MembershipExt.asmx/GetListTwmb001RoundAction',
                page_size: 10,
                row_start: 0,
                row_end: 10,
        ...
        var execFilterForm = function () {
            ...
            if (isEmpty(round_action_status) == false) {
                ...
                conditions.push('(a.mb_id in (select mb_id from vietair_international.twmb_round_action where office_department_id = a.office_department_id and status = ' + round_action_status + '))');
            }
