(function () {
    ...
    VA.views.flightCustomer.ManagePolicyCustomer = function () {
        ...
        function add() {
            ...
            data_post.package_name = "PK_BD_FS_POLICY_CUSTOMER_001";

            data_post.object_name = "INSERT_POLICY_CUSTOMER_001";
        ...
        function update() {
            ...
            data_post.object_name = "UPDATE_POLICY_CUSTOMER_001";
        ...
        var viewManageFlightCustomer = function (sqid) {
            ...
            jQuery.ajax({
                url: "/FlightCustomer/ViewManagePolicyCustomerLog",
                dataType: 'html',
                type: 'POST',
                data: data_post,
                success: function (data) {
