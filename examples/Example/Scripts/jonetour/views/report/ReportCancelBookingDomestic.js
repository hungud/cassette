(function () {
    ...
    VA.views.report.ReportCancelBookingDomestic = function () {
        ...
        var getDataReportCancelBooking = function (from_day, to_day, mbId) {
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    PACKAGE_NAME: 'PK_BD_REPORT_TICKETING',
                ...
                success: function (resp) {
                    ...
                    if (resp.TypeMsg > 0) {
                         ...
                         $('#report_cancel_booking_domestic').html("");

                         jQuery('#tmp_report_ticketing').tmpl(resp.Data).appendTo('#report_cancel_booking_domestic');
        ...
        var prepareData = function (resp) {
            ...
            //tinh tong ma dich vu huy va ti le 
        ...
        var initOptionFilterForm = function () {
            ...
            data_post.package_name = "PK_BD_REPORT_TICKETING";
