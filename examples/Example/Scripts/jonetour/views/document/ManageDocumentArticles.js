(function () {
    ...
    VA.views.document.ManageDocumentArticles = function () {
        ...
        var execFilterForm = function () {
            ...
            var office_department_id = $('#OFFICE_DEPARTMENT_ID_SEARCH', '#filterForm').val();
            ...
            if (isEmpty(office_department_id) == false) {
                ...
                conditions.ARTICLE.office_department_id = office_department_id;
            } 
        ...
        var initControls = function () {
            ...
            initSearchOfficeDepartment();
            // getDataForCategoryInput();
            initOfficeDepartment();
        ...
        var initOfficeDepartment = function () {

            var data_post = {};
                        
            data_post.PACKAGE_NAME = 'PK_BD_ARTICLE_CATEGORY_MANAGE';

            data_post.OBJECT_NAME = 'GET_LIST_OFFICE_DEPARTMENTS';
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp != null && resp.TypeMsg > 0) {
                        ...
                        jQuery('#OFFICE_DEPARTMENT_ID').html('<option value="">-- [ Chọn phòng ban ] --</option>');

                        $('#tmp_list_office_department').tmpl(resp.Data.CURSOR_DATA).appendTo("#OFFICE_DEPARTMENT_ID");
                ...
                error: function (http, message, exc) {
                    jwm.Alert.HideAjaxProcessing("#insertUpdateCategoryForm", true);
                    jwm.Alert.ShowMsg("#insertUpdateCategoryForm", -1, message + " " + exc, 'Thông báo');
                }
            });
            return false;
        }

        var initSearchOfficeDepartment = function () {
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp != null && resp.TypeMsg > 0) {
                        ...
                        $('#OFFICE_DEPARTMENT_ID_SEARCH').empty();

                        jQuery('#OFFICE_DEPARTMENT_ID_SEARCH').html('<option value="">-- [ Chọn phòng ban ] --</option>');

                        $('#tmp_list_office_department').tmpl(resp.Data.CURSOR_DATA).appendTo("#OFFICE_DEPARTMENT_ID_SEARCH");
