(function () {
    ...
    VA.views.hotels.ViewHotels = function () {
        ...
        var initDocumentForm = function () {
            ...
            jQuery(window).scroll(function () {
                ...
                var offset_document_hotel = $('#document_hotel').offset().top;
                ...
                if (offset_document_hotel <= offset_scroll) {
                    $('#document_hotel').addClass('fix');
                    $('.copy-document-hotel').height($('#document_hotel').height());
                }
                ...
                var offset_copy_document_hotel = $('.copy-document-hotel').offset().top;
                if (offset_copy_document_hotel > offset_document_hotel) {
                    $('#document_hotel').removeClass('fix');
                    $('.copy-document-hotel').height(0);
                }
        ...
        var getDataAjaxFancyTree = function (callback) {
            ...
            jQuery.ajax({
                url: _configs.service_wss_vietair_tv_url + "/Hotels.asmx/GetListHierarchicalCategories",
                dataType: "jsonp",
                data: {
                    parent_id: 0, site_id: _configs.site_id, is_get_content: false
                },
        ...
        var getCategoryContent = function (categoryId) {
            ...
            jQuery.ajax({
                url: _configs.service_wss_vietair_tv_url + "/Hotels.asmx/GetCategoryHotel",
                dataType: "jsonp",
                data: {
                    site_id: _configs.site_id, is_get_content: true, category_id: categoryId
                },
                success: function (data) {
                    ...
                    if (data.TypeMsg > 0) {
                        ...
                        $('#document_hotel').empty();

                        $('#tmp_hotel_info').tmpl(data.Data).appendTo('#document_hotel');
