(function () {
    ...
    VA.views.accounting.ViewAccountingPaymentMessageForAccounting = function () {

        var _configs = {
        }

        var _grid_accounting_payment_message_for_accounting_paged = null;

        var _grid_accounting_payment_message_for_accounting_config = null;

        var initGridAccountingPaymentMessageForAccounting = function () {

            _grid_accounting_payment_message_for_accounting_config = {
            ...
            _grid_accounting_payment_message_for_accounting_config.data = {
                package_name: 'PK_BD_ACC_PAYMENT_MESSAGE',
        ...
        var renderGridAccountingPaymentMessageForAccounting = function () {

            _grid_accounting_payment_message_for_accounting_paged = new SS.core.GridPaged();

            _grid_accounting_payment_message_for_accounting_paged.init(_grid_accounting_payment_message_for_accounting_config);
        }
        ...
        var setGridConfigFromQueryString = function () {
            ...
            _grid_accounting_payment_message_for_accounting_config.data = {
                ...
                p_conditions: JSON.stringify(conditions),
                row_start: 0,
                row_end: _grid_accounting_payment_message_for_accounting_config.page_size
            };

            _grid_accounting_payment_message_for_accounting_config.onRenderComplete = function () {
        ...
        var initGrid = function () {
            ...
            initGridAccountingPaymentMessageForAccounting();

            setGridConfigFromQueryString();

            renderGridAccountingPaymentMessageForAccounting();
                ...
                var config_popup = {
                    ...
                    args: {
                        ...
                        FunctionCallBack: function () {
                            ...
                            ajax_download(_grid_accounting_payment_message_for_accounting_config.ajax_url, data_post_download);
        ...
        var updateStatus = function (status, dataForm) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.TypeMsg > 0) {
                        _grid_accounting_payment_message_for_accounting_paged.renderGrid();
                    }
                },
