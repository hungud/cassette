(function () {
    ...
    VA.views.accounting.ManageAccountingFlightBookingInternational = function () {
        ...
        var initGrid = function () {
            _grid_paged_config = {
                ...
                grid_selector: '#grid',
                ajax_url: _configs.service_wss_galileo_vietair_tv_url + '/ListInfo.asmx/GetListFlightBookingInfo',
                page_size: 20,
                row_start: 0,
                row_end: 20
            }
        ...
        var execFilterForm = function (exportFile) {
            ...
            if (isEmpty(customer_info_first_name_last_name) == false) {
                ...
                conditions.push("( a.order_id in (select order_id from vietair_international.customer_info where regexp_like(first_name || ' ' || last_name,'" + customer_info_first_name_last_name + "','i') ) )");
            }
            ...
            if (isEmpty(airline_code) == false) {
                ...
                conditions.push("( a.order_id in (select order_id from vietair_international.travel_info where airline_code = '" + airline_code + "') )");
            }
            ...
            if (exportFile == true) {
                ...
                var url_download = _configs.service_wss_galileo_vietair_tv_url + '/ListInfo.asmx/GetListFlightBookingInfo';
        ...
        var initEnhanceFilterForm = function () {
            ...
            jQuery.ajax({
                url: _configs.service_wss_galileo_vietair_tv_url + "/ListInfo.asmx/GetListUserHandleFlightBooking",
                dataType: "jsonp",
                data: {
            ...
            jQuery.ajax({
                url: _configs.service_wss_galileo_vietair_tv_url + "/ListInfo.asmx/GetListAirlineFromFlightBooking",
                dataType: "jsonp",
                data: {
                    rowStart: 0, rowEnd: 1000
                },
            ...
            jQuery.ajax({
                url: _configs.service_wss_galileo_vietair_tv_url + "/ListInfo.asmx/GetListPaymentMethods",
                dataType: "jsonp",
                data: {
                    rowStart: 0, rowEnd: 1000
                },
            ...
            jQuery(document).bind('getBookingInfoPartial', function (e) {
                ...
                jQuery('a[data-booking-status]').click(function () {
                    ...
                    if (booking_status == -1) {
                        ...
                        //xu ly xong
                        //if (confirm('Quý khách chắc chắn xử lý xong mã dịch vụ QT' + data_form.order_id + ' ?') == false) {
                        //    return;
                        //}
