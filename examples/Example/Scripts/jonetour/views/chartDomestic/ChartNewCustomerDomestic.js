(function () {
    ...
    VA.views.chartDomestic.ChartNewCustomerDomestic = function () {
        ...
        var initTitleChart = function () {
            ...
            $('#chart-new-customer-domestic').css('display', 'block');
            $('.title-charts').text('Thống kê số lượng khách hàng đặt mới nội địa');
        ...
        var prepareDataFlyBookingInfo = function () {
            ...
            var from_day = $('#from_day_chart_month', '#chart-new-customer-domestic').val();

            var to_day = $('#to_day_chart_month', '#chart-new-customer-domestic').val();
            ...
            $('#id_sum_put', '#chart-new-customer-domestic').html(sum_dat_ph);
            //------------------Tong xuat moi-------------------------
        ...
        var prepareDataFlyBookingInfoByYear = function () {
            ...
            var date = $('#date_chart_year_flight_booking_value', '#chart-new-customer-domestic').val();
        ...
        var prepareDataFlyBookingInfoByMonth = function () {
            ...
            // console.log(data.DataChart_KH_DAT_MOI_DA_HUY);
        ...
        var bindDataChartFlightBookingStatisticByDayToDay = function (data) {
            $('#bao_cao_theo_ma_dich_vu', '#chart-new-customer-domestic').highcharts({
                title: {
                ...
                tooltip: {
                    ...
                    //    labels = '';
                    //    if (this.series.name == 'KH đặt mới') {
                    //        labels = 'Ngày <b>' + this.x + '</b> có <b>' + this.y + '</b> khách đặt mới';
                    //    }
                ...
                //[{
                //    name: 'KH đặt mới',
                //    color: '#4f81bd',//set mau cho line
                //    data: data.DataChart_KH_DAT_MOI
        ...
        var bindDataChartFlightBookingStatisticByDayToDayDaXuat = function (data) {
            $('#bao_cao_theo_ma_dich_vu_da_xuat', '#chart-new-customer-domestic').highcharts({
                chart: {
                    type: 'column'
                },
                title: {
                ...
                tooltip: {
                    ...
                    //pointFormat: '{series.name}: {point.y}<br/>KH đặt mới:{point.stackTotal}'
        ...
        var initChartFlightBookingStatistic = function () {
            ...
            $('#btn_view_chart_year_flight_booking', '#chart-new-customer-domestic').unbind('click')
            $('#btn_view_chart_year_flight_booking', '#chart-new-customer-domestic').click(function () {//khi click chon xem bieu do theo nam
                flag_type_of_fight_booking_info = 0;
                var year = $('#date_chart_year_flight_booking_value', '#chart-new-customer-domestic').val();
                getDataChartFlyBookingInfoByYear(year);//dau vao la nam

            });

            $('#btn_view_chart_month_flight_booking', '#chart-new-customer-domestic').unbind('click')
            $('#btn_view_chart_month_flight_booking', '#chart-new-customer-domestic').click(function () {//khi click chon xem bieu do theo thang
            ...
            $('#btn_view_chart_month_flight_booking_range', '#chart-new-customer-domestic').unbind('click')
            $('#btn_view_chart_month_flight_booking_range', '#chart-new-customer-domestic').click(function () {//khi click chon xem bieu do theo ngay den ngay
                flag_type_of_fight_booking_info = 2;
                var from_day_chart_month = $('#from_day_chart_month', '#chart-new-customer-domestic').val();
                var to_day_chart_month = $('#to_day_chart_month', '#chart-new-customer-domestic').val();
            ...
            if (init_data_chart_flight_booking_statistic == false) {
                ...
                $('#date_chart_month_flight_booking_value', '#chart-new-customer-domestic').val(date);
                //  var date = $('#date_chart_month_flight_booking_value', '#chart-new-customer-domestic').val();

                var year = $.format.date(current_date, 'yyyy');
                $('#date_chart_year_flight_booking_value', '#chart-new-customer-domestic').val(year);//tạo giá trị năm ban đầu

                var from_date = $.format.date(current_date, 'dd/MM/yyyy');
                $('#from_day_chart_month', '#chart-new-customer-domestic').val(from_date);//tạo giá trị ngay ban đầu

                var to_date = $.format.date(current_date, 'dd/MM/yyyy');
                $('#to_day_chart_month', '#chart-new-customer-domestic').val(to_date);
