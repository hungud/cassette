(function () {
    ...
    VA.views.travelTour.ManageTravelTourDetail_Ex03 = function () {

        var _configs = {
        }

        var grid_manage_travel_tour_detail_ex03_configs = null;

        var grid_manage_travel_tour_detail_ex03_paged = null;

        var initGridManageTravelTourDetailEx03 = function () {

            grid_manage_travel_tour_detail_ex03_configs = {
            ...
            grid_manage_travel_tour_detail_ex03_configs.data = {
                package_name: 'PK_BD_TOUR_DETAIL_EX03',
                object_name: 'GET_LIST_TOUR_INFO_DETAIL_EX03',
        ...
        function setGridConfigFromQueryString() {
            ...
            conditions.TOUR_INFO_DETAIL_EX03= {};



            if (isEmpty(tour_detail_id) == false) {
                tour_detail_id = tour_detail_id.trim();
                conditions.TOUR_INFO_DETAIL_EX03.TOUR_DETAIL_ID = tour_detail_id;
            }
            ...
            grid_manage_travel_tour_detail_ex03_configs.data = {
                ...
                p_conditions: JSON.stringify(conditions),
                row_start: 0,
                row_end: grid_manage_travel_tour_detail_ex03_configs.page_size

            };

            grid_manage_travel_tour_detail_ex03_configs.onRenderComplete = function () {
        ...
        function addTour() {
            ...
            data_post.package_name = 'PK_BD_TOUR_DETAIL_EX03';

            data_post.object_name = 'INSERT_TOUR_INFO_DETAIL_EX03';
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp.TypeMsg > 0) {
                        ...
                        renderGridManageTravelTourDetailEx03();
                    }
                },
                error: function (http, message, exc) {
                    jwm.Alert.HideAjaxProcessing('#insertUpdate');
        ...
        function UpdateTour() {
            ...
            data_post.object_name = 'UPDATE_TOUR_INFO_DETAIL_EX03';
        ...
        var initControls = function () {
            ...
            initGridManageTravelTourDetailEx03();
        ...
        var renderGridManageTravelTourDetailEx03 = function (conditions) {

            if (conditions) {
                grid_manage_travel_tour_detail_ex03_configs.data.p_conditions = JSON.stringify(conditions);
            }

            grid_manage_travel_tour_detail_ex03_paged = new SS.core.GridPaged();

            grid_manage_travel_tour_detail_ex03_paged.init(grid_manage_travel_tour_detail_ex03_configs);
        }
