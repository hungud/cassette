(function () {
    ...
    VA.views.travelTour.ManageTravelTourDetail_Ex02_Airline = function () {

        var _configs = {
        }

        var grid_manage_travel_tour_detail_ex02_airline_configs = null;

        var grid_manage_travel_tour_detail_ex02_airline_paged = null;

        var initGridManageTravelTourDetailEx02Airline = function () {

            grid_manage_travel_tour_detail_ex02_airline_configs = {
            ...
            grid_manage_travel_tour_detail_ex02_airline_configs.data = {
                package_name: 'PK_BD_TOUR_DETAIL_EX02_AIRLINE',
                object_name: 'GET_LIST_TOUR_DETAIL_AIRLINE',
        ...
        function setGridConfigFromQueryString() {
            ...
            conditions.TOUR_INFO_DETAIL_EX02_AIRLINE = {};



            if (isEmpty(tour_detail_id) == false) {
                tour_detail_id = tour_detail_id.trim();
                conditions.TOUR_INFO_DETAIL_EX02_AIRLINE.TOUR_DETAIL_ID = tour_detail_id;
            }
            ...
            grid_manage_travel_tour_detail_ex02_airline_configs.data = {
                ...
                p_conditions: JSON.stringify(conditions),
                row_start: 0,
                row_end: grid_manage_travel_tour_detail_ex02_airline_configs.page_size
        ...
        function addTour() {
            ...
            data_post.package_name = 'PK_BD_TOUR_DETAIL_EX02_AIRLINE';

            data_post.object_name = 'INSERT_TOUR_DETAIL_AIRLINE';
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp.TypeMsg > 0) {
                        ...
                        renderGridManageTravelTourDetailEx02Airline();
                    }
                },
                error: function (http, message, exc) {
                    jwm.Alert.HideAjaxProcessing('#insertUpdate');
        ...
        function UpdateTour() {
            ...
            data_post.object_name = 'UPDATE_TOUR_DETAIL_AIRLINE';
        ...
        var renderGridManageTravelTourDetailEx02Airline = function (conditions) {

            if (conditions) {
                grid_manage_travel_tour_detail_ex02_airline_configs.data.p_conditions = JSON.stringify(conditions);
            }

            grid_manage_travel_tour_detail_ex02_airline_paged = new SS.core.GridPaged();

            grid_manage_travel_tour_detail_ex02_airline_paged.init(grid_manage_travel_tour_detail_ex02_airline_configs);
        }
        ...
        var initControls = function () {
            ...
            initGridManageTravelTourDetailEx02Airline();
