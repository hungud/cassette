(function () {
    ...
    VA.views.travelTour.ManageTravelTourDetail_Ex02_Hotel = function () {

        var _configs = {
        }

        var grid_manage_travel_tour_detail_ex02_hotel_configs = null;

        var grid_manage_travel_tour_detail_ex02_hotel_paged = null;

        var initGridManageTravelTourDetailEx02Hotel = function () {

            grid_manage_travel_tour_detail_ex02_hotel_configs = {
            ...
            grid_manage_travel_tour_detail_ex02_hotel_configs.data = {
                package_name: 'PK_BD_TOUR_DETAIL_EX02_HOTEL',
                object_name: 'GET_LIST_TOUR_DETAIL_HOTEL',
        ...
        function setGridConfigFromQueryString() {
            ...
            conditions.TOUR_INFO_DETAIL_EX02_HOTEL = {};



            if (isEmpty(tour_detail_id) == false) {
                tour_detail_id = tour_detail_id.trim();
                conditions.TOUR_INFO_DETAIL_EX02_HOTEL.TOUR_DETAIL_ID = tour_detail_id;
            }
            ...
            grid_manage_travel_tour_detail_ex02_hotel_configs.data = {
                ...
                p_conditions: JSON.stringify(conditions),
                row_start: 0,
                row_end: grid_manage_travel_tour_detail_ex02_hotel_configs.page_size
        ...
        function addTour() {
            ...
            data_post.package_name = 'PK_BD_TOUR_DETAIL_EX02_HOTEL';

            data_post.object_name = 'INSERT_TOUR_DETAIL_HOTEL';
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp.TypeMsg > 0) {
                        ...
                        renderGridManageTravelTourDetailEx02Hotel();
                    }
                },
                error: function (http, message, exc) {
                    jwm.Alert.HideAjaxProcessing('#insertUpdate');
        ...
        function UpdateTour() {
            ...
            data_post.object_name = 'UPDATE_TOUR_DETAIL_HOTEL';
        ...
        var renderGridManageTravelTourDetailEx02Hotel = function (conditions) {

            if (conditions) {
                grid_manage_travel_tour_detail_ex02_hotel_configs.data.p_conditions = JSON.stringify(conditions);
            }

            grid_manage_travel_tour_detail_ex02_hotel_paged = new SS.core.GridPaged();

            grid_manage_travel_tour_detail_ex02_hotel_paged.init(grid_manage_travel_tour_detail_ex02_hotel_configs);
        }
        ...
        var initControls = function () {
            ...
            initGridManageTravelTourDetailEx02Hotel();
