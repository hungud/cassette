(function () {
    ...
    VA.views.travelTour.ManageTravelTourDetail_Ex02_Price = function () {

        var _configs = {
        }

        var grid_manage_travel_tour_detail_ex02_price_configs = null;

        var grid_manage_travel_tour_detail_ex02_price_paged = null;

        var initGridManageTravelTourDetailEx02Price = function () {

            grid_manage_travel_tour_detail_ex02_price_configs = {
            ...
            grid_manage_travel_tour_detail_ex02_price_configs.data = {
                package_name: 'PK_BD_TOUR_DETAIL_EX02_PRICE',
                object_name: 'GET_LIST_TOUR_DETAIL_PRICE',
        ...
        function setGridConfigFromQueryString() {
            ...
            conditions.TOUR_INFO_DETAIL_EX02_PRICE = {};



            if (isEmpty(tour_detail_id) == false) {
                tour_detail_id = tour_detail_id.trim();
                conditions.TOUR_INFO_DETAIL_EX02_PRICE.TOUR_DETAIL_ID = tour_detail_id;
            }
            ...
            grid_manage_travel_tour_detail_ex02_price_configs.data = {
                ...
                p_conditions: JSON.stringify(conditions),
                row_start: 0,
                row_end: grid_manage_travel_tour_detail_ex02_price_configs.page_size

            };

            grid_manage_travel_tour_detail_ex02_price_configs.onRenderComplete = function () {
        ...
        function addTour() {
            ...
            data_post.package_name = 'PK_BD_TOUR_DETAIL_EX02_PRICE';

            data_post.object_name = 'INSERT_TOUR_DETAIL_PRICE';
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp.TypeMsg > 0) {
                        ...
                        renderGridManageTravelTourDetailEx02Price();
                    }
                },
                error: function (http, message, exc) {
                    jwm.Alert.HideAjaxProcessing('#insertUpdate');
        ...
        function UpdateTour() {
            ...
            data_post.object_name = 'UPDATE_TOUR_DETAIL_PRICE';
        ...
        var initControls = function () {
            ...
            initGridManageTravelTourDetailEx02Price();
        ...
        var renderGridManageTravelTourDetailEx02Price = function (conditions) {

            if (conditions) {
                grid_manage_travel_tour_detail_ex02_price_configs.data.p_conditions = JSON.stringify(conditions);
            }

            grid_manage_travel_tour_detail_ex02_price_paged = new SS.core.GridPaged();

            grid_manage_travel_tour_detail_ex02_price_paged.init(grid_manage_travel_tour_detail_ex02_price_configs);
        }
