(function () {
    ...
    VA.views.article.ManageVietAirArticles = function () {
        ...
        var getDataAjaxFancyTree = function (callback) {
            ...
            jQuery.ajax({
                url: _configs.service_wss_vietair_tv_url + "/service02/articles/get",
                dataType: "json",
                type: 'POST',
                data: {
        ...
        var viewLogInfo = function (sqId) {
            ...
            jQuery.ajax({
                url: "/Article/ViewLogVietairArticle",
                dataType: 'html',
                type: 'POST',
                data: data_post,
        ...
        var viewDetailLogInfo = function (sqId) {
            ...
            jQuery.ajax({
                url: "/Article/ViewLogVietairArticleDetail",
                dataType: 'html',
                type: 'POST',
                data: data_post,
                success: function (data) {
        ...
        var initGridVietairArticles = function () {
            ...
            grid_vietair_articles_configs = {
                ...
                grid_selector: '#grid',
                ajax_url: _configs.service_wss_vietair_tv_url + "/service02/articles/get",
