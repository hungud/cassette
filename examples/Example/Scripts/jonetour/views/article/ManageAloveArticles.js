(function () {
    ...
    VA.views.article.ManageAloveArticles = function () {
        ...
        var initComments = function (articleId) {
            ...
            var configs = {
                ...
                service_wss_alove_vn_url: _configs.SERVICE_WSS_ALOVE_VN_URL,
        ...
        var viewLogInfo = function (sqId) {
            ...
            jQuery.ajax({
                url: "/Article/ViewLogAloveArticle",
                dataType: 'html',
                type: 'POST',
                data: data_post,
        ...
        var viewDetailLogInfo = function (sqId) {
            ...
            jQuery.ajax({
                url: "/Article/ViewLogAloveArticleDetail",
                dataType: 'html',
                type: 'POST',
                data: data_post,
                success: function (data) {
                    ...
                    $('#ViewLogAloveArticleDetail').show();
        ...
        var execFilterForm = function () {
            ...
            grid_alove_articles_configs.data.p_conditions = JSON.stringify(conditions);
        ...
        var grid_alove_articles_configs = null;

        var grid_alove_articles_paged = null;

        var initGridAloveArticles = function () {

            grid_alove_articles_configs = {
                tmp_paged_selector: '#tmp_GridPaged',
                paged_selector: '#grid_paged',
                tmp_grid_selector: '#tmp_grid',
                grid_selector: '#grid',
                ajax_url: _configs.SERVICE_WSS_ALOVE_VN_URL + "/service02/articles/get",
            ...
            grid_alove_articles_configs.data = {
            ...
            grid_alove_articles_configs.onRenderComplete = function () {

            };

        }

        var renderGridAloveArticles = function () {

            grid_alove_articles_paged = new SS.core.GridPaged();

            grid_alove_articles_paged.init(grid_alove_articles_configs);
        }
        ...
        var initControls = function () {
            ...
            jQuery(document).bind('deserializeObjectPackageToFormV2', function (e) {
                ...
                $('#link-to-manage-seo').click(function () {
                    ...
                    var link_manage_seo = '/Article/AloveArticlesSeoLink?ref_sq_id=' + e.objectForm.SQ_ID;
