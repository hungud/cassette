(function () {
    ...
    VA.views.article.ManageTamVuongArticles = function () {
        ...
        var getDataAjaxFancyTree = function (callback) {
            ...
            jQuery.ajax({
                url: _configs.service_wss_tam_vuong_com_url + "/service02/articles/get",
                dataType: "json",
                type: 'POST',
                data: {
        ...
        var initComments = function (articleId) {
            ...
            var configs = {
                ...
                service_wss_tam_vuong_com_url: _configs.service_wss_tam_vuong_com_url,
                ...
                type_comment_id: 2 //bai viet tamvuong.com
            };
        ...
        var viewLogInfo = function (sqId) {
            ...
            jQuery.ajax({
                url: "/Article/ViewLogTamVuongArticle",
                dataType: 'html',
                type: 'POST',
                data: data_post,
        ...
        var viewDetailLogInfo = function (sqId) {
            ...
            jQuery.ajax({
                url: "/Article/ViewLogTamVuongArticleDetail",
                dataType: 'html',
                type: 'POST',
                data: data_post,
                success: function (data) {
                    ...
                    $('#ViewLogTamVuongArticleDetail').show();
        ...
        var execFilterForm = function () {
            ...
            grid_tam_vuong_articles_configs.data.p_conditions = JSON.stringify(conditions);
        ...
        var grid_tam_vuong_articles_configs = null;

        var grid_tam_vuong_articles_paged = null;

        var initGridTamVuongArticles = function () {

            grid_tam_vuong_articles_configs = {
            ...
            grid_tam_vuong_articles_configs.data = {
            ...
            grid_tam_vuong_articles_configs.onRenderComplete = function () {

            };

        }

        var renderGridTamVuongArticles = function () {

            grid_tam_vuong_articles_paged = new SS.core.GridPaged();

            grid_tam_vuong_articles_paged.init(grid_tam_vuong_articles_configs);
        }
        ...
        var initControls = function () {
            ...
            jQuery(document).bind('deserializeObjectPackageToFormV2', function (e) {
                ...
                $('#link-to-manage-seo').click(function () {
                    ...
                    var link_manage_seo = '/Article/TamVuongArticlesSeoLink?ref_sq_id=' + e.objectForm.SQ_ID;
