(function () {
    ...
    VA.views.airline.ManageTravelInfo = function () {
        ...
        var initOptionGrid = function () {
            option_grid_add_update = {
                ...
                ajax_url_grid: _configs.service_wss_vietair_tv_url + '/ListInfo.asmx/GetListTravelInfo'
            }
        }
        ...
        var initControls = function () {
            ...
            jQuery(document).bind('deserializeObjectToFormView', function (e) {
                ...
                jQuery(e.tmpFormId).tmpl(e.json).appendTo(e.formId).slideDown('slow');
            });
        }
