(function () {
    ...
    VA.views.marketing.ManagePromotionCodeEvent = function () {

        var _configs = {
        }

        var grid_manage_promotion_code_event_configs = null;

        var grid_manage_promotion_code_event_paged = null;

        var initGridManagePromotionCodeEvent = function () {

            grid_manage_promotion_code_event_configs = {
            ...
            grid_manage_promotion_code_event_configs.data = {
                package_name: 'PK_BD_PROMOTION_CODE_EVENT',
                object_name: 'GET_LIST_PROMOTION_CODE_EVENT',
        ...
        var renderGridManagePromotionCodeEvent = function (conditions) {

            if (conditions) {
                grid_manage_promotion_code_event_configs.data.p_conditions = JSON.stringify(conditions);
            }

            grid_manage_promotion_code_event_paged = new SS.core.GridPaged();

            grid_manage_promotion_code_event_paged.init(grid_manage_promotion_code_event_configs);
        }


        var initControls = function () {

            initGridManagePromotionCodeEvent();

            renderGridManagePromotionCodeEvent();
            ...
            jQuery.ajax({
                ...
                success: function (resp) {
                    ...
                    if (resp.TypeMsg > 0) {
                        ...
                        grid_manage_promotion_code_event_paged.renderGrid();
                    }
                },
