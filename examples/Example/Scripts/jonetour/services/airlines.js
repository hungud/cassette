(function () {
    ...
    SS.services.airlines = function () {
        
        var _configs = {
            txtFormId: '.txtFlightCarrier',
            txtToId: '.txtFlightCarrier',
            startClass: '.startplace-carrier',
            listContain: '#list-carrier-departure',
            interStart: '#inter-carrier-departure',
            interSubmit: '#submit-carrier-departure',
            errorStart: '.error-carrier-departure'
        }
            ...
            $(_configs.startClass).focus(function () {
                ...
                if (isEmpty(interairlineInput)) {
                    $(_configs.interSubmit).click(function () {
                        ...
                        if (val == '') {
                            $(_configs.errorStart).text('Xin hãy nhập tên thành phố hoặc sân bay để tiếp tục.');
        ...
        var initAirlinesAutoComplete = function () {
            // Set auto complete
            var vUrl = 'http://wss.vietair.tv/ListInfo.asmx/GetListAirlines';
